/**
 * SWEEP 2C - HONEST RULER (fixed horizon, no weekend entries)
 *
...
(function main() {
  ...
  const out = [];
  out.push('SWEEP 2C - HONEST RULER  ' + new Date().toISOString());
  out.push('');
  ...
  fs.writeFileSync('sweep2c_results.txt', out.join('\n') + '\n');
  console.log('wrote sweep2c_results.txt');
})();
