...
const TRADES = [
    { n: 1,  side:'Short', entryQld:'2026-07-06 22:11', ticks:-304, mae:300, mfe:605 },
    { n: 2,  side:'Short', entryQld:'2026-07-13 08:51', ticks:-304, mae:300, mfe:138 },
    { n: 3,  side:'Short', entryQld:'2026-07-13 10:41', ticks:1996, mae:47,  mfe:2000 },
    { n: 4,  side:'Long',  entryQld:'2026-07-14 08:16', ticks:-304, mae:300, mfe:64 },
    { n: 5,  side:'Long',  entryQld:'2026-07-14 09:31', ticks:1996, mae:258, mfe:2000 },
    { n: 6,  side:'Short', entryQld:'2026-07-15 17:31', ticks:1996, mae:150, mfe:2000 },
    { n: 7,  side:'Short', entryQld:'2026-07-16 17:46', ticks:1563, mae:298, mfe:1965 },
    { n: 8,  side:'Short', entryQld:'2026-07-17 09:26', ticks:1996, mae:150, mfe:2000 },
    { n: 9,  side:'Short', entryQld:'2026-07-20 16:36', ticks:-304, mae:300, mfe:52 },
    { n:10,  side:'Long',  entryQld:'2026-07-24 03:26', ticks:-304, mae:300, mfe:52 },
    { n:11,  side:'Short', entryQld:'2026-07-27 11:41', ticks:-304, mae:300, mfe:139 },
    { n:12,  side:'Short', entryQld:'2026-07-28 00:41', ticks:-304, mae:300, mfe:373 },
    { n:13,  side:'Short', entryQld:'2026-07-28 08:46', ticks:1996, mae:242, mfe:2000 },
    { n:14,  side:'Short', entryQld:'2026-08-03 08:41', ticks:-304, mae:300, mfe:306 },
    { n:15,  side:'Short', entryQld:'2026-08-08 00:11', ticks:-304, mae:300, mfe:267 },
    { n:16,  side:'Short', entryQld:'2026-08-08 03:06', ticks:-304, mae:300, mfe:272 },
    { n:17,  side:'Short', entryQld:'2026-08-11 01:01', ticks:-304, mae:300, mfe:154 },
    { n:18,  side:'Short', entryQld:'2026-08-11 02:26', ticks:297,  mae:20,  mfe:465 },
    { n:19,  side:'Short', entryQld:'2026-08-13 00:16', ticks:339,  mae:213, mfe:364 },
    { n:20,  side:'Short', entryQld:'2026-08-13 08:06', ticks:-304, mae:300, mfe:115 },
    { n:21,  side:'Short', entryQld:'2026-08-13 16:11', ticks:-304, mae:300, mfe:295 },
    { n:22,  side:'Short', entryQld:'2026-08-14 02:41', ticks:-304, mae:300, mfe:26 },
    { n:23,  side:'Long',  entryQld:'2026-08-14 23:36', ticks:-304, mae:300, mfe:299 },
    { n:24,  side:'Short', entryQld:'2026-08-18 13:01', ticks:1393, mae:74,  mfe:1581 },
    { n:25,  side:'Short', entryQld:'2026-08-20 08:10', ticks:-301, mae:302, mfe:64 },
    { n:26,  side:'Short', entryQld:'2026-08-20 13:15', ticks:1272, mae:246, mfe:1691 }
];
...
// ─── tag every trade ─────────────────────────────────────────────────────────
const out = [];
out.push('BOARD SWEEP — WIDE ERA (Jul 6 - Aug 20, 26 trades, one config)');
...
for (const t of TRADES) {
    ...
    out.push(
        ...
        (row.liqL.toFixed(1) + '/' + row.liqS.toFixed(1) + '/' + row.liqN).padEnd(17) );
}
...
fs.writeFileSync(path.join(DIR, 'wide_sweep_results.txt'), out.join('\n') + '\n');
console.log('\nwrote wide_sweep_results.txt');
